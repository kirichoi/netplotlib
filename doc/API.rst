...
.. method:: netplotlib.Network(model)
    ...
    .. method:: Network.draw(show=True, savePath=None, dpi=150)
    ...
    .. method:: Network.savefig(path, dpi=150)
...
.. method:: netplotlib.NetworkEnsemble(models)
    ...
    .. method:: Network.drawWeightedDiagram(show=True, savePath=None, dpi=150)
    ...
    .. method:: Network.drawNetworkGrid(nrows, ncols, auto=False, show=True, savePath=None, dpi=150)
...
.. autofunction:: netplotlib.netplotlib.getListOfAlgorithms
